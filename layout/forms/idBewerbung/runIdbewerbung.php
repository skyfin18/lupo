...
if ($_POST["fname"] !== ""
    ...
    $query = "INSERT INTO `foIdbewerbung` (`id`, `title`, `fname`, `lname`, `tele`, `mobil`, `email`, `jobid`, `bdate`, `upload`, `kommi`, `firstdate`) VALUES (NULL, '$title', '$fname', '$lname', '$tele', '$mobil', '$email', '$jobid', '$bdate', 'upload', '$kommi', '$firstdate');";
